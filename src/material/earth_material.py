...
class EarthMaterial(Material):
    ...
    def __init__(self,
        ...
        water_texture: Texture=None,
        use_shadows: bool=True,
        properties: Dict={}
    ) -> None:

        vert_code, frag_code = ShaderUtils.loadShaderCode("earth_material")
        ...
        self.addUniform("float", "u_shininess", 5)
        ...
        if water_texture == None:
            self.addUniform("bool", "u_useWaterTexture", False)
        else:
            self.addUniform("bool", "u_useWaterTexture", True)
            self.addUniform("sampler2D", "u_waterTexture", [water_texture._TextureRef, 3])
