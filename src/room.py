...
from stellar.sun_material import SunMaterial
...
class App(Base):
    ...
    def initialize(self) -> None:
        ...
        self._PlanetScene.add(self._CameraRig)

        # set up planet light
        self._Ambient = AmbientLight(color=[0.2, 0.2, 0.2])
        self._PlanetScene.add(self._Ambient)
        self._Directional = DirectionalLight()
        self._Directional.setDirection([-0.3, -0.3, 0])
        self._PlanetScene.add(self._Directional)

        # set up sun light
        self._SunAmbient = AmbientLight()
        self._SunScene.add(self._SunAmbient)

        self._Renderer.enableShadows(self._Directional)

        # scene info
        print(f"Scene info:")
        self._PlanetScene.printNodeTree()
    ...
    def update(self) -> None:
        ...
        # render
        self._Renderer.render(self._PlanetScene, self._Camera)    
